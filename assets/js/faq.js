...
(function () {
  ...
  var KB = [
    ...
    { q: 'Does BetterTap make sparkling water?',
      k: 'sparkling carbonated co2 fizzy bubbles soda',
      a: "Select configurations offer sparkling water using a CO₂ cylinder. Ask our team which model fits your kitchen and we'll point you to the right one." },
    { q: 'What warranty comes with BetterTap?',
      k: 'warranty guarantee coverage 2 year two year 5 year five year extension protect',
      a: "BetterTap comes with a 2-year warranty, extendable to 5 years for full peace of mind." },
