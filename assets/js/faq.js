...
(function () {
  ...
  var KB = [
    ...
    { q: 'What temperatures can I choose?',
      k: 'temperature settings chilled cold ambient room boiling hot degrees range',
      a: "Dial in exactly what you need — from chilled and refreshing through room temperature to a rolling boil — so every drink and recipe gets the right temperature." },
    { q: 'How big is the BetterTap unit?',
      k: 'size dimensions width height depth inches countertop footprint how big unit measurements',
      a: "It's a compact countertop unit on the scale of a small appliance — about 11 inches wide and roughly 14 inches deep and tall — so it tucks neatly beside the sink." },
    { q: 'How do I return BetterTap at the end of a lease term?',
      k: 'return end term lease cancel collection collect send back disconnect remove final month',
      a: "Just let us know during your final month and we'll book a free collection. A technician disconnects and removes the unit for you." },
    { q: 'How soon is the unit collected once I arrange it?',
      k: 'collection collect timing how soon days week weekday schedule pickup time window',
      a: "Collection is typically arranged within a week or so on a weekday, and we'll confirm a time window in advance so you know when to expect us." },
    { q: 'What happens if something stops working?',
      k: 'something wrong broken stops working repair support technical help replacement fix service',
      a: "We've got you. On a lease plan, technical help and in-home repairs or replacement are handled for you — just let us know and we'll send someone out." },
    { q: 'Do I own BetterTap or am I leasing it?',
      k: 'own buying hiring lease leasing rent ownership outright belongs whose retain',
      a: "It depends on your plan: buy it outright and it's yours, or choose the lease and we retain ownership while covering servicing and sending replacement filters and lamps on schedule." },
    { q: 'Will my monthly lease price go up?',
      k: 'price increase go up rise fixed rate subscription monthly lease cost change introductory',
      a: "No. Once any introductory offer ends, your rate stays fixed for the length of your minimum term — what you sign up for is what you pay." },
    { q: 'What if BetterTap is damaged during the satisfaction-guarantee period?',
      k: 'damaged damage satisfaction guarantee period wear refund return repair scratch broken trial',
      a: "Normal everyday wear is fine and fully covered. Damage beyond that may need to be put right before a refund is issued." },
    { q: 'Can I refer friends and earn a reward?',
      k: 'refer friend referral reward credit invite share program scheme earn link',
      a: "Yes. Active customers in good standing can refer as many friends as they like and earn a reward for each one who joins. Ask our team for your referral link." }
  ];
